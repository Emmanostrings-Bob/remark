...
const Header = () => {
  ...
  return (
    <nav className="fixed top-0 bg-white w-full md:pr-[2%] lg:pr-0 md:pl-[2%] min-h-[72px] px-4 flex z-50 ">
      ...
      <button onClick={toggleMenu} className="absolute top-9 right-4 outline-0 border-0 w-8 flex-col justify-start items-start gap-y-2 lg:hidden inline-flex">
            <span className="w-8 h-1 bg-white transform rotate-45 translate-y-1"></span>
            <span className="w-8 h-1 bg-white transform -rotate-45 -translate-y-1"></span>
          </button>
